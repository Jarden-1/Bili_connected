...
const MESSAGES: Record<"zh" | "en", MessageCatalog> = {
  zh: {
    ...
    pageShareQuickCreate: "快速创建",
    pageShareQuickCreatePending: "创建中...",
    pageShareQuickCreateFailed: "创建失败：{error}",
    pageShareRoomCode: "房间码",
    pageShareRoomCodeCopy: "复制",
    pageShareRoomCodeCopied: "已复制",
    pageShareJoinPlaceholder: "输入房间号",
    pageShareJoin: "加入",
    pageShareJoinFailed: "加入失败：{error}",
    pageShareMembersHeading: "成员 ({count})",
    pageShareNoMembers: "暂无其他成员",
    pageShareNickname: "你的昵称",
    pageShareNicknameEdit: "修改",
    pageShareNicknameSave: "保存",
    pageShareNicknameCancel: "取消",
    pageShareNicknameSaved: "昵称已更新",
    pageShareLeaveRoom: "退出房间",
  ...
  en: {
    ...
    pageShareQuickCreate: "Create room",
    pageShareQuickCreatePending: "Creating...",
    pageShareQuickCreateFailed: "Create failed: {error}",
    pageShareRoomCode: "Room code",
    pageShareRoomCodeCopy: "Copy",
    pageShareRoomCodeCopied: "Copied",
    pageShareJoinPlaceholder: "Enter room code",
    pageShareJoin: "Join",
    pageShareJoinFailed: "Join failed: {error}",
    pageShareMembersHeading: "Members ({count})",
    pageShareNoMembers: "No other members yet",
    pageShareNickname: "Your nickname",
    pageShareNicknameEdit: "Edit",
    pageShareNicknameSave: "Save",
    pageShareNicknameCancel: "Cancel",
    pageShareNicknameSaved: "Nickname updated",
    pageShareLeaveRoom: "Leave room",
